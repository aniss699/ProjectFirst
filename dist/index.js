...
router15.post("/", requireAuth, asyncHandler2(async (req, res) => {
...
router15.get("/", asyncHandler2(async (req, res) => {
...
router15.get("/:id", asyncHandler2(async (req, res) => {
...
router15.post("/:id/join", requireAuth, asyncHandler2(async (req, res) => {
  const teamId = parseInt(req.params.id);
...
router15.put("/:id", requireAuth, asyncHandler2(async (req, res) => {
  const teamId = parseInt(req.params.id);
  if (isNaN(teamId)) {
    return res.status(400).json({
      error: "ID d'\xE9quipe invalide"
...
router15.delete("/:id", requireAuth, asyncHandler2(async (req, res) => {
  const teamId = parseInt(req.params.id);
  if (isNaN(teamId)) {
    return res.status(400).json({
      error: "ID d'\xE9quipe invalide"
...
var open_teams_default = router15;
...
router16.get("/", optionalAuth, async (req, res) => {
  try {
...
router16.get("/:id", optionalAuth, async (req, res) => {
  try {
